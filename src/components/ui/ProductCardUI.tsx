 ...
 * Diseño moderno para tienda de playeras
 */
        ...
        <Card className="bg-card border-border overflow-hidden">
          <CardContent className="p-4">
            <Link to={`/products/${logic.product.slug}`} className="block">
              <div className="aspect-square bg-muted rounded-xl mb-3 overflow-hidden relative group">
                ...
                <div className="absolute top-2 left-2 flex flex-col gap-1">
                  ...
                  {!logic.inStock && (
                    <span className="bg-muted-foreground text-white text-xs px-2 py-1 rounded-full font-semibold">
                      Agotado
                    </span>
                  )}
                </div>
