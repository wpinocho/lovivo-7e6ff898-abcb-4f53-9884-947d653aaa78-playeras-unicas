 ...
 * Template para tienda de playeras con diseño moderno
 */
...
export const EcommerceTemplate = ({
  ...
  const footer = (
    <div className={`hero-gradient text-white py-12 ${footerClassName}`}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="mt-4 text-white/90">
              Tu tienda de playeras de confianza
            </p>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-white/20 text-center text-white/80">
          <p>&copy; 2024 Playeras Style. Todos los derechos reservados.</p>
        </div>
      </div>
    </div>
  )
